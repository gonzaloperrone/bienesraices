...
$db = connectDB();
//Obtain properties
$consult = "SELECT * FROM properties WHERE id = ${id}";
...
<main class="container section">
    ...
    <form class="form" action="/admin/properties/create.php" method="POST" enctype="multipart/form-data">
        <fieldset>
            ...
            <img src="/images/<?php echo $propertyImg ?>" alt="<?php echo $title ?>" class="smallImg">
        ...
        <input type="submit" value="Actualizar propiedad" class="greenButton">
